...
class CalendarUtils {
    ...
    companion object {
         ...
         * 같은 달,일 체크
         */
        fun isSameDay(first: DateTime, second: DateTime?): Boolean = if(second == null){
            false
        } else {
...
//            return Color.parseColor("#000000")
        ...
        fun DateTime.getFormatString(pattern: String = "yyyy.MM.dd HH:mm:ss"): String = this.toString(
